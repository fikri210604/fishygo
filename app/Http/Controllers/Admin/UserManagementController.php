...
class UserManagementController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            $this->logException($e, ['action' => 'UserManagementController@store']);
            return back()->withInput()->with('error', $this->errorMessage($e, 'Gagal membuat user.'));
        }
    }
    ...
    public function update(Request $request, User $user)
    {
        ...
        try {
            ...
            $this->logException($e, ['action' => 'UserManagementController@update', 'user_id' => $user->id]);
            return back()->withInput()->with('error', $this->errorMessage($e, 'Gagal memperbarui user.'));
        }
    }
    ...
    public function destroy(User $user)
    {
        ...
        try {
            ...
            $this->logException($e, ['action' => 'UserManagementController@destroy', 'user_id' => $user->id]);
            return back()->with('error', $this->errorMessage($e, 'Gagal menghapus user.'));
        }
    }
}
